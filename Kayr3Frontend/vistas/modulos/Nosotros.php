        ...
        <div id="nosotros" class="col s12">
            ...
            <div class="container">
                ...
                <ul class="collapsible popout" data-collapsible="accordion">
                    <li>
                        <div class="collapsible-header active"><i class="fa fa-history" aria-hidden="true"></i> HISTORIA</div>
                    ...
                    <li>
                        <div class="collapsible-header"><i class="fa fa-bullseye" aria-hidden="true"></i> MISIÓN</div>
                        <div class="collapsible-body"><span>Lorem ipsum dolor sit amet.</span>
                            <p>Lorem Ipsum es simplemente el texto de relleno de las imprentas y archivos de texto.
                                Lorem Ipsum ha sido el texto de relleno estándar de las industrias desde el año 1500,
                                cuando un impresor (N. del T. persona que se dedica a la imprenta) desconocido usó una
                    ...
                    <li>
                        <div class="collapsible-header"><i class="fa fa-hourglass-start" aria-hidden="true"></i> VISIÓN</div>
                        <div class="collapsible-body"><span>Lorem ipsum dolor sit amet.</span>
                            <p>Lorem Ipsum es simplemente el texto de relleno de las imprentas y archivos de texto.
                                Lorem Ipsum ha sido el texto de relleno estándar de las industrias desde el año 1500,
                                cuando un impresor (N. del T. persona que se dedica a la imprenta) desconocido usó una
