...
<div class="hide-on-med-and-down" id="slide">
          ...
          echo '<li>
              ...
              <div class="slideOpciones '.$value["tipoSlide"].'">';
                ...
                if($value["boton"] != ""){
                  ...
                  echo '<a href="'.$value["url"].'" class="btn-verproducto">
                    
                    <button class="btn  colorSecundario text-uppercase">
...
<center class="hide-on-med-and-down">
  
  <button id="btnSlide" class="colorSecundario">
