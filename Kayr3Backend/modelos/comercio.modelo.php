...
class ModeloComercio{
	...
	static public function mdlActualizarColores($tabla, $id, $datos){
		...
		$stmt = Conexion::conectar()->prepare("UPDATE $tabla SET barraSuperior = :barraSuperior,colorSecundario=:colorSecundario, textoSuperior = :textoSuperior, colorFondo = :colorFondo, colorTexto = :colorTexto  WHERE id = :id");

		$stmt->bindParam(":barraSuperior", $datos["barraSuperior"], PDO::PARAM_STR);
		$stmt->bindParam(":colorSecundario", $datos["colorSecundario"], PDO::PARAM_STR);
	...
	static public function mdlActualizarScript($tabla, $id, $datos){
		...
		$stmt = Conexion::conectar()->prepare("UPDATE $tabla SET apiChat = :apiChat, pixelFacebook = :pixelFacebook, googleAnalytics = :googleAnalytics WHERE id = :id");

		$stmt->bindParam(":apiChat", $datos["apiChat"], PDO::PARAM_STR);
	...
	static public function mdlActualizarInformacion($tabla, $id, $datos){
		...
		modoPaypal = :modoPaypal, clienteIdPaypal = :clienteIdPaypal, llaveSecretaPaypal = :llaveSecretaPaypal, modoPayu = :modoPayu, merchantIdPayu = :merchantIdPayu, accountIdPayu = :accountIdPayu, apiKeyPayu = :apiKeyPayu,Banco=:Banco,NumeroDecuenta=:NumeroDecuenta,PropietarioCU=:PropietarioCU WHERE id = :id");
		...
		$stmt->bindParam(":PropietarioCU", $datos["PropietarioCU"], PDO::PARAM_STR);
		$stmt->bindParam(":id", $id, PDO::PARAM_INT);
