...
class AjaxComercio{
	...
	public function ajaxCambiarScript(){
		...
		$datos = array("apiChat"=>$this->apiChat,
	...
	public function ajaxCambiarInformacion(){
		...
		$datos = array("impuesto"=>$this->impuesto,
						...
						"PropietarioCU"=>$this->PropietarioCU);
...
if(isset($_POST["barraSuperior"])){
	...
	$colores->  colorSecundario=$_POST["colorSecundario"];
...
if(isset($_POST["apiChat"])){

	$script = new AjaxComercio();
	$script -> apiChat = $_POST["apiChat"];
...
if(isset($_POST["impuesto"])){
	...
	$informacion -> Banco = $_POST["Banco"];
	$informacion -> NumeroDecuenta = $_POST["NumeroDecuenta"];
	$informacion -> PropietarioCU = $_POST["PropietarioCU"];
