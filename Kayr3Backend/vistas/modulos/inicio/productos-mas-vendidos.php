...
<div class="box box-default">
	...
	<!-- box-header -->
  	<div class="box-header with-border">
    	...
    	<h3 class="box-title">Productos más pedidos</h3>
 	...
 	<!-- box-body -->
  	<div class="box-body">
	    ...
	    <div class="row">
          ...
          for($i = 0; $i < 5; $i++){
              ...
              echo '<li><i class="fa fa-circle-o text-'.$colores[$i].'"></i> '.$productos[$i]["NombreProducto"].'</li>';
          }
      ...
      <?php
        ...
        for($i = 0; $i < 5; $i++){
            ...
            echo '<li>        
                    <a href="#">'.$productos[$i]["NombreProducto"].'
