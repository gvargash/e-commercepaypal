	...
	<div class="box-body formularioInformacion">
	    ...
	    <div class="form-group">
	      ...
	      <div class="input-group">
	        ...
	        <span class="input-group-addon"><i class=""></i>S/.</span>
		...
		<div class="panel panel-default">
	  		...
	  		<div class="panel-heading">
	      		...
	      		<h4 class="text-uppercase">Datos Bancarios</h4>
	      	...
	      	<div class="panel-body">
	        	...
	        	<div class="form-group row">
		          	...
		          	<div class="col-xs-3">
		            	...
		            	<label for="comment">Banco:</label>
		            	<input type="text" class="form-control cambioInformacion" id="Banco" value="<?php echo $comercio["Banco"]; ?>" >

		          	</div>
	          
	          		<div class="col-xs-3">

	        			<label for="comment">Número de cuenta:</label>
	      
	            		<input type="text" class="form-control cambioInformacion" id="NumeroDecuenta" value="<?php echo $comercio["NumeroDeCuenta"]; ?>">

	     		 	</div>

	      			<div class="col-xs-3">

	            		<label for="comment">Propietario:</label>
	      
	             		<input type="text" class="form-control cambioInformacion" id="PropietarioCU" value="<?php echo $comercio["PropietarioCU"]; ?>">
