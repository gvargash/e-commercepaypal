...
<head>
  ...
  <title>Kayr3 | Print Intelligence</title>
    ...
    /*=============================================
     ...
     =============================================*/
        if(isset($_GET["ruta"])){
          ...
          =============================================*/
            $rutaEditarCat=ControladorCategoria::ctrMostrarCategoria($item,$valor);
            if($_GET["ruta"]==$rutaEditarCat["ruta"]){
              $ruta=$_GET["ruta"];
            }
            

          /*=============================================
          URL´S AMIGABLES DE MARCA
          =============================================*/
            $rutaEditarMar=ControladorMarca::ctrMostrarMarca($item,$valor);
            if($_GET["ruta"]==$rutaEditarMar["ruta"]){
              $ruta=$_GET["ruta"];
            }

            /*=============================================
          URL´S AMIGABLES DE PEDIDO
          =============================================*/
            $rutaDetallePedido=ControladorVentas::crtPedidoDetalle($item, $valor);;
            if($_GET["ruta"]==$rutaDetallePedido["ruta"]){
              $ruta=$_GET["ruta"];
            }

            /*=============================================
          URL´S AMIGABLES DE producto
          =============================================*/
            $rutaEditarProducto=ControladorProductos::crtProductoEditar($item, $valor);;
            if($_GET["ruta"]==$rutaEditarProducto["ruta"]){
              $ruta=$_GET["ruta"];
            }
          /*=============================================
          URL´S AMIGABLES
          =============================================*/
            if($_GET["ruta"]== "inicio" ||
               ...
               $_GET["ruta"]== "perfil" ||
               $_GET["ruta"]== "salir" ||
               $_GET["ruta"]=="agregarcategoria" ||
               $_GET["ruta"]=="agregarmarca" ||
               $_GET["ruta"]=="detallepedido" || 
               $_GET["ruta"]=="agregarproductos" || 
               $_GET["ruta"]== "error")
            {
              include "modulos/".$_GET["ruta"].".php";

            }else if($rutaEditarCat!=null){
               include "modulos/categoriaeditar.php";
            }else if ($rutaEditarMar!=null) {
              include "modulos/editarmarca.php";
            }else if ($rutaDetallePedido!=null) {
              include "modulos/detallepedido.php";
            }else if ($rutaEditarProducto!=null) {
              include "modulos/editarproducto.php";
            }else{
...
<script src="vistas/js/tablas.js"></script>
