...
$(".cambioColor").change(function(){
	...
	$("#guardarColores").click(function(){
		...
		datos.append("colorSecundario",colorSecundario);
...
$("input[name='colorRedSocial']").on("ifChecked", function(){
	...
	var redes = ["facebook", "youtube","twitter","google","instagram"];
...
var PropietarioCU = $("#PropietarioCU").val();
/*=============================================
CAMBIAR MODO PAYPAL
=============================================*/
...
$(".cambioInformacion").change(function(){
	...
	PropietarioCU = $("#PropietarioCU").val();
...
function cambiarInformacion(modoPaypal, modoPayu){
	...
	datos.append("NumeroDecuenta", NumeroDecuenta);
	datos.append("PropietarioCU", PropietarioCU);
